...
Begin VB.Form frmTahun 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         _Version        =   393216
      End
      Begin MSDataGridLib.DataGrid gridTahun 
         Bindings        =   "frmTahun.frx":0000
         Height          =   2655
         Left            =   240
         TabIndex        =   9
         Top             =   3240
...
Private Sub cmdSave_Click()
 On Error GoTo pesan
    ...
    If Not Text2.Text = "" Then
        Adodc1.Recordset!tahun = Text2.Text
...
Private Sub gridTahun_Click()
Text2.Text = gridTahun.Columns(0).Text
Text4.Text = gridTahun.Columns(1).Text
End Sub
