...
Begin VB.Form frmSurveyor 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         _Version        =   393216
      End
      Begin MSDataGridLib.DataGrid gridSurveyor 
         Bindings        =   "frmSurveyor.frx":0000
         Height          =   2655
         Left            =   240
         TabIndex        =   7
         Top             =   3240
...
cmdAdd.Enabled = True
    ...
    Adodc1.Refresh
    gridSurveyor.AllowUpdate = False
End Sub
...
Private Sub gridSurveyor_Click()
Text2.Text = gridSurveyor.Columns(0).Text
Text4.Text = gridSurveyor.Columns(1).Text
End Sub
